...
{
	public:
		MonsterType() {reset(); exists = false; codenome = ""; realName = "";}
		virtual ~MonsterType() {reset(); exists = false; codenome = ""; realName = "";}
		...
		std::string name, nameDescription, codenome, realName;
		bool exists;
