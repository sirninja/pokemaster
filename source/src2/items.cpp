...
int32_t Items::getItemIdByClientId2(int32_t spriteId)
{
	uint32_t i = 100;
	ItemType* iType = NULL;
	do
...
const std::string& Items::getItemNameById(int32_t Id)
{
	uint32_t i = 100;
	ItemType* iType = NULL;
	do
	{
		if((iType = items.getElement(i)) && i == Id)
...
int32_t Items::getItemSpriteIdById(int32_t Id)
{
		uint32_t i = 100;
		ItemType* iType = NULL;
		do
