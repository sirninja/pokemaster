...
class LuaScriptInterface
{
	...
	protected:
		...
		//lua functions
		static int32_t luaDoCreateNpcWithFocus(lua_State* L);
		static int32_t luaSetNpcFocus(lua_State* L);
		static int32_t luaGetNpcMaster(lua_State* L);
		static int32_t luaSetNpcFollow(lua_State* L);
		static int32_t luaGetNpcFocus(lua_State* L);
		static int32_t luaIsSummon(lua_State* L);
		static int32_t luaDoCreatureCastSpell(lua_State* L); // by OrochiElf
		static int32_t luaGetItemSpriteIdById(lua_State* L);
		static int32_t luaGetItemClientIdBySpriteId(lua_State* L);
		...
		static int32_t luaDoPlayerOpenChannelsList(lua_State* L);
