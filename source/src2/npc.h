...
class NpcScriptInterface : public LuaScriptInterface
{
	...
	protected:
		...
		static int32_t luaActionCanKill(lua_State* L);
		static int32_t luaActionCanIdle(lua_State* L);
		static int32_t luaActionSay(lua_State* L);
		static int32_t luaActionMaster(lua_State* L);
		static int32_t luaGetNpcFollow(lua_State* L);
		...
		static int32_t luaActionAttackedCreature(lua_State* L);

		static int32_t luaGetNpcId(lua_State* L);
		static int32_t luaGetNpcFocus(lua_State* L);
...
class Npc : public Creature
{
	public:
		...
		virtual uint32_t getFocus() {return focusCreature;}
		virtual uint32_t getCanKill() {return canKillPlayer;}
		...
		void setCanKill(int32_t num);
		void setCanIdle(bool bb);
	...
	protected:
		...
		uint32_t walkTicks;
		const Creature* focusCreatures;
		std::string name, nameDescription, m_filename;
		int32_t talkRadius, idleTime, idleInterval, canKillPlayer;
		bool floorChange, attackable, walkable, isIdle, hasBusyReply, defaultPublic, canIdle;
		int64_t lastVoice;
